...
## Symbols
<div align="center">
  <img src="./media/logos/software-logo.jpg" alt="Sofwares Logo" width="300" height="300"style="border-radius:50%;"> &nbsp;&nbsp; &nbsp;&nbsp;
  <img src="./media/logos/economy-logo.png" alt="Economy Logo" width="190" height="190" style="border-radius:50%;"> &nbsp;&nbsp;
</div>
